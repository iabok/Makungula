...
<div id="middle">
	<div id="main" class="clearfix">		
					...
					<div id="pageHead">
									<h1 style="font-size:30px;">View Farmers</h1>
									<!--<div id="fm-border"></div>-->
					</div>
					<?php
					if(isset($_GET['msg'])){
 ...
 #pagination starts------------------
				...
				#End of pagination----------
							...
							"LEFT OUTER JOIN mk_category usr " .
							"ON ar.cat_id = usr.cat_id " .
							"WHERE ar.cat_id=".$_GET['cat_id']." ORDER BY ar.farmers_id DESC $pages->limit";
